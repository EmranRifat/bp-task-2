...
const Explore = () => {
    return (
        <div>
         <footer className="footer py-8 bg-[#F7F7F7]  pl-20 font-gray-700">
  <div>
  ...
  <div>
    <span className="footer-title">Community
</span> 
...
<footer className="footer items-center p-10 bg-[#F7F7F7] text-gray-700">
  <div className="items-center grid-flow-col">
    ...
    <p>© 2023 Airbnb, Inc.·TermsSitemapPrivacyYour Privacy Choices</p>
  </div> 
